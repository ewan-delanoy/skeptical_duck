...
Image.imagination(find_one_prime_equivalent(m))(l);;
...
let temp3=List.flatten(Image.imagination(function b->let m=(b*b+dd)/4 in
Image.imagination(function a->(a,b,m/a) )(Set_of_integers.forget_order(Primes.divisors(m))) )(temp2)) in
...
(temp4,Image.imagination(function (a,b,c)->(a,-b,c))(temp5));;
