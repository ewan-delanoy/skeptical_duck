...
let expand cs summary =
        ...
        (match summary with 
        Needed_data_summary_t.Everything -> Fw_with_githubbing.all_endinglesses cs
       |Selection(needed_modules,needed_subdirs)-> 
        ...
        let original_noncompilables = Fw_with_githubbing.noncompilable_files cs in
        (*
        ...
        *)      
        ...
        ) (Fw_with_githubbing.usual_compilable_files cs) in
