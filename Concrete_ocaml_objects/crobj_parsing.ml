...
let next_basic_increase_in_preludy_case s idx idx1=
   if Substring.is_a_substring_located_at variant_opener s idx 
   then next_basic_increase_in_variant_opening_case s idx idx1
   else 
   if Substring.is_a_substring_located_at record_arrow s idx 
   then next_basic_increase_in_field_naming_case s idx idx1
   else 
   if Substring.is_a_substring_located_at record_opener s idx 
