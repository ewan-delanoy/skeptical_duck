...
let bundle_main_dir x=Dfa_root.of_string(x.bundle_main_dir);;
let subdirectory x=Dfa_subdirectory.of_string(x.subdirectory);;
...
let rename_endsubdirectory (old_subdir,new_subdirname) x=
   {
	      bundle_main_dir = x.bundle_main_dir;
   		  subdirectory    = Dfa_subdirectory.without_trailing_slash(
   		                    Dfa_subdirectory.rename_endsubdirectory
   		                       (old_subdir,new_subdirname) 
   		                       (Dfa_subdirectory.of_string(x.subdirectory)));
