...
let second_init config (compilables_to_be_watched,noncompilables) =
    ...
    let compute_info=( fun path->
   ...
   ) in 
     {
       ...
       Fw_wrapper_t.compilable_files = Image.vorstellung compute_info compilables_to_be_watched;
       noncompilable_files = Image.vorstellung compute_info noncompilables;
