...
module Private = struct 
  ...
  module Enter = struct 
    ...
    let reflect_latest_changes_in_github = univariate Fw_with_small_details.reflect_latest_changes_in_github ;;
    ...
    let rename_module_on_filename_level_and_in_files = univariate_producer Fw_with_small_details.rename_module;;  
  ...
  module Cached = struct 
    ...
    let reflect_latest_changes_in_github = add_caching Enter.reflect_latest_changes_in_github ;;
  ...
  module Modularized_details = struct
    ...
    let reflect_latest_changes_in_github = passive_trsp Cached.reflect_latest_changes_in_github ;;  
  ...
  module Order = struct 
    ...
    let reflect_latest_changes_in_github = passive_trsp Modularized_details.reflect_latest_changes_in_github ;;  
  ...
  module Needed_dirs = struct 
    ...
    *)  
    let passive_trsp fw = trsp fw (Some(fun new_fw old_dep_val arg ad -> 
      ...
      let reflect_latest_changes_in_github = passive_trsp Order.reflect_latest_changes_in_github ;;  
  ...
  module Needed_libs = struct 
    ...
    *)  
    ...
    let reflect_latest_changes_in_github = passive_trsp Needed_dirs.reflect_latest_changes_in_github ;;  
  ...
  module All_subdirectories = struct 
    ...
    *)  
    ...
    let reflect_latest_changes_in_github = passive_trsp Needed_libs.reflect_latest_changes_in_github ;;  
...
module All_printables = struct 
  ...
  *)  
  let passive_trsp fw = trsp fw (Some(fun new_fw old_dep_val arg ad -> 
    ...
    let reflect_latest_changes_in_github = passive_trsp All_subdirectories.reflect_latest_changes_in_github ;;  
  ...
  module Exit = struct
    ...
    let reflect_latest_changes_in_github = extract_univariate All_printables.reflect_latest_changes_in_github ;;  
