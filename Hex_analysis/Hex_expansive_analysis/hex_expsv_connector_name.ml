...
let to_nondefault_molecular_linker cname apex junction= match cname with 
    Hex_connector_name_t.Inner(inner)-> Hex_expsv_inner_connector_name.to_nondefault_molecular_linker inner
   |Border(_,border) -> Hex_expsv_border_connector_name.to_nondefault_molecular_linker border apex junction;;

let to_readable_string = function 
    Hex_connector_name_t.Inner(inner)-> Hex_expsv_inner_connector_name.to_readable_string inner
