...
let compress_to_springless elt= match elt with 
    Hex_expsv_kite_element_t.Earth(island)-> Hex_kite_springless_element_t.Earth(island)
...
let of_springless = function
    Hex_kite_springless_element_t.Earth(island)-> Hex_expsv_kite_element_t.Earth(island)
