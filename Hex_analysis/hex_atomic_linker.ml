...
let to_concrete_object = function 
   Hex_atomic_linker_t.Pair (cell1,cell2) ->
       Concrete_object_t.Variant (pair_label,Image.imagination Hex_cell.to_concrete_object [cell1;cell2])
 | Eyed_claw (dir1,dir2,cell) -> 
       Concrete_object_t.Variant (eyed_label,
          (Image.imagination Hex_cardinal_direction.to_concrete_object [dir1;dir2])@[Hex_cell.to_concrete_object cell])
 ;;
...
let support = function 
 ...
 | Eyed_claw (d1,d2,cell) -> 
    ...
    Hex_cell_set.safe_set (Image.imagination Hex_cell.of_int_pair ipairs) ;;
    
let ipair_support mlclr = 
   let (Hex_cell_set_t.S l)=support mlclr in 
   Image.imagination Hex_cell.to_int_pair l;;
...
let to_readable_string = function
 ...
 | Eyed_claw (d1,d2,cell) -> 
      let ipairs = Hex_connector_data.advanced_eyed_claw d1 d2 (Hex_cell.to_int_pair cell) in 
      let cells =Hex_cell_set.safe_set (Image.imagination Hex_cell.of_int_pair ipairs) in
