...
let first_moves l=
    Hex_cell_set.safe_set (Image.imagination Hex_finished_game.first_move l);;

let seek_companions_for_games fgames flesses =
   Image.imagination (fun fgame->(fgame,Hex_finished_game.seek_companion_for_game fgame flesses) ) fgames;;   

let seek_companions_for_strategies flesses fgames =
   Image.imagination (fun fles->(fles,Hex_finished_game.seek_companion_for_strategy fles fgames) ) flesses;;   
