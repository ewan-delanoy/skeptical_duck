...
let active_part_when_joined_to_another_cell  
     (Hex_first_alternative_in_springboard_t.Fa(cell,path,sol,actv)) cell2=
...
let to_readable_string  (Hex_first_alternative_in_springboard_t.Fa(cell,path,sol,actv))=
...
let wet_earth  
  (Hex_first_alternative_in_springboard_t.Fa(cell,path,sol,actv))=    
