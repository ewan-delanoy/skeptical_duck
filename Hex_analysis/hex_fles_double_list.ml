...
let of_concrete_object crobj=
   ...
   Hex_fles_double_list_t.DL(
      Crobj_converter_combinator.to_list Hex_flattened_end_strategy_field.of_concrete_object arg1,
      Crobj_converter_combinator.to_list Hex_flattened_end_strategy_field.of_concrete_object arg2
   );;

let to_concrete_object (Hex_fles_double_list_t.DL(l1,l2))=
   Concrete_object_t.Variant("Hex_"^"fles_double_list_t.DL",
     [Crobj_converter_combinator.of_list Hex_flattened_end_strategy_field.to_concrete_object l1;
      Crobj_converter_combinator.of_list Hex_flattened_end_strategy_field.to_concrete_object l2
     ]);;
