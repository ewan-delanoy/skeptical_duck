...
In the Player_is_attacked_but_fights_back variant, the first argument is the sequence of moves
that reached the position , and the second argument is the single
remaining unplayed active cell.

In the Player_surrenders variant, the first two argument are as in the Player_is_attacked_but_fights_back variant
