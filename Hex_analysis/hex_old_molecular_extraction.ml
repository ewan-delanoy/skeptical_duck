...
#use"Hex_analysis/hex_old_molecular_extraction.ml";;
...
let extract_from_set mlclr passive_part =
    ...
    Hex_old_molecular_extraction_t.E(mlclr,remaining_ones);;
...
let support  (Hex_old_molecular_extraction_t.E(mlclr,remaining_ones))=
