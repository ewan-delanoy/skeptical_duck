...
let of_concrete_object = Concrete_object.unwrap_lonely_variant Private.namings;;
let to_concrete_object = Concrete_object.wrap_lonely_variant Private.namings;;
