...
let downwards_noneyed_claw = function 
    Hex_double_hump_qualifier_t.Big_followed_by_small 
       -> Hex_typical_border_connector_name_t.Bs_D 
   |Hex_double_hump_qualifier_t.Small_followed_by_big
       -> Hex_typical_border_connector_name_t.Sb_D ;;    

let leftwards_noneyed_claw = function 
    Hex_double_hump_qualifier_t.Big_followed_by_small 
       -> Hex_typical_border_connector_name_t.Bs_L 
   |Hex_double_hump_qualifier_t.Small_followed_by_big
       -> Hex_typical_border_connector_name_t.Sb_L ;; 

let rightwards_noneyed_claw = function 
    Hex_double_hump_qualifier_t.Big_followed_by_small 
       -> Hex_typical_border_connector_name_t.Bs_R 
   |Hex_double_hump_qualifier_t.Small_followed_by_big
       -> Hex_typical_border_connector_name_t.Sb_R ;;    

let upwards_noneyed_claw = function 
    Hex_double_hump_qualifier_t.Big_followed_by_small 
       -> Hex_typical_border_connector_name_t.Bs_U 
   |Hex_double_hump_qualifier_t.Small_followed_by_big
       -> Hex_typical_border_connector_name_t.Sb_U ;; 
...
let for_side side =
    ...
    (Image.image (fun specifier->
        Hex_typical_border_connector_name_t.Eyed_claw(specifier,side)
    ) ortho)
    @
    (
     Image.image (
    ...
    @
    [
      Hex_typical_border_connector_name_t.Pyramid(side);
      Hex_typical_border_connector_name_t.Small_pyramid(side) ;
      Hex_typical_border_connector_name_t.Border_bridge(side) ; 
      Hex_typical_border_connector_name_t.Walleye1(side) ; 
    ] ;;

let to_nondefault_molecular_linker nm apex junction = match nm with 
    Hex_typical_border_connector_name_t.Eyed_claw(d1,d2) -> 
