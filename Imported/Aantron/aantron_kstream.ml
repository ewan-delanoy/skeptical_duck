...
#use"Imported/Aantron/aantron_kstream.ml";;

*)



  (* adapted from Markup.ml/Kstream at https://github.com/aantron/markup.ml *)

   

  type 'a t = {mutable f : exn Aantron_markup_common.cont -> unit Aantron_markup_common.cont -> 'a Aantron_markup_common.cont -> unit} ;;
