...
#use"Imported/Aantron/aantron_markup_common.ml";;

*)

(* adapted from  https://github.com/aantron/markup.ml *)
...
let u_rep = Uchar.to_int Buenzli_uutf.u_rep ;;

let add_utf_8 buffer c =
  Buenzli_uutf.Buffer.add_utf_8 buffer (Uchar.unsafe_of_int c) ;;
