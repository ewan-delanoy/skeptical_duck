...
#use"Imported/Aantron/aantron_markup_error.ml";;

*)


(* adapted from Markup.ml/Error at https://github.com/aantron/markup.ml *)
   ...
   type 'a handler = 'a -> t -> unit Aantron_markup_common.cps ;;
   type parse_handler = Aantron_markup_common.location handler ;;
   type write_handler = (Aantron_markup_common.signal * int) handler ;;
