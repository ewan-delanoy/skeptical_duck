...
let t txl=
  let s_decomps=decompressions 2 (Txl_field.uncapitalized_adjustable_decompressions txl)  
  and s_expansions=expansions 2 (Txl_field.expansions txl) 
  and s_iwords=inert_words  2 (Txl_field.uncapitalized_inert_words txl) 
  and s_lc_abbreviations=abbreviations 2 (Txl_field.uncapitalized_left_core_abbreviations txl) 
  and s_px_abbreviations=abbreviations 2(Txl_field.uncapitalized_prefix_abbreviations txl) 
  and s_ci_decomps=decompressions 2 (Txl_field.adjustable_decompressions txl)  
  and s_ci_iwords=inert_words  2 (Txl_field.inert_words txl) 
  and s_ci_lc_abbreviations=abbreviations 2 (Txl_field.left_core_abbreviations txl) 
  and s_ci_px_abbreviations=abbreviations 2 (Txl_field.prefix_abbreviations txl) 
  in 
  "{\n"^
