...
let optional_for_three (s1,s2,s3)=
   let os1=optional_for_one s1
   and os2=optional_for_one s2 
   and os3=optional_for_one s3 in 
   if List.mem None [os1;os2;os3]
   then None 
   else Some(Option.unpack os1,Option.unpack os2,Option.unpack os3);;
...
let generalize_for_three l=l@(Option.filter_and_unpack optional_for_three l);;
