...
#use"Van_der_Waerden/Fixed_width/vdwfw_nonempty_index.ml";;
...
module Private = struct 
  ...
  (Vdwfw_nonempty_index_t.Part(x1,y1)) ->
  ...
  let order = (Private.full_order:  Vdwfw_nonempty_index_t.t Total_ordering_t.t);;
