...
let to_subdirectory  (Dfn_full_t.J(_r,s,_m,_e))=s;;
let to_module  (Dfn_full_t.J(_r,_s,m,_e))=m;;
let to_ending (Dfn_full_t.J(_r,_s,_m,e))=e;;

let to_rootless (Dfn_full_t.J(_r,s,m,e))=(Dfn_rootless_t.J(s,m,e));; 
let to_endingless (Dfn_full_t.J(r,s,m,_e))=(Dfn_endingless_t.J(r,s,m));; 

   
let to_rootless_line (Dfn_full_t.J(_r,s,m,e))=
...
let relocate (Dfn_full_t.J(r,_old_subdir,m,e)) new_subdir=
