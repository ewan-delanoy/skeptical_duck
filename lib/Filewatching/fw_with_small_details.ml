...
module Private = struct
   ...
   let constructor mother =
     Fw_poly.extend_fw_with_archives_to_fw_with_small_details 
       mother  
       ~small_details_in_files:(Fwc_with_archives.compute_all_small_details mother) ;;
   ...
   let plunge_fw_configuration config= Fw_poly.extend_fw_with_archives_to_fw_with_small_details (Fwc_with_archives.plunge_fw_configuration config) ~small_details_in_files:[] ;; 
