...
#use"lib/Filewatching/fwc_file_watcher.ml";;
...
let of_concrete_object = Fw_poly.Private.Crobj.of_concrete_object ;;
...
let to_concrete_object = Fw_poly.Private.Crobj.to_concrete_object ;;
