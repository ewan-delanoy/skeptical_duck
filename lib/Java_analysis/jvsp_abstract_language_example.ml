...
AL ([
   ...
   ("AmbiguousName",Disjunction([Concat(["Identifier"]);Concat(["AmbiguousName";"AtomicDot";"Identifier"])]));
   ...
   ("AnnotationInterfaceDeclaration",Just_a_concat(["StarredInterfaceModifier";"AtomicSnail";"AtomicInterface";"Identifier";"AtomicLb";"StarredAnnotationInterfaceMemberDeclaration";"AtomicRb"]));
   ...
   ("ArrayCreationExpression",Disjunction([Concat(["AtomicNew";"PrimitiveType";"StarredAnnotation";"AtomicLb";"Expression";"AtomicRb";"StarredDimExpr";"OptionalDims"]);Concat(["AtomicNew";"ClassOrInterfaceType";"StarredAnnotation";"AtomicLb";"Expression";"AtomicRb";"StarredDimExpr";"OptionalDims"]);Concat(["AtomicNew";"PrimitiveType";"StarredAnnotation";"AtomicLb";"AtomicRb";"StarredDimsElement";"AtomicLb";"OptionalVariableInitializerList";"OptionalCm";"AtomicRb"]);Concat(["AtomicNew";"ClassOrInterfaceType";"StarredAnnotation";"AtomicLb";"AtomicRb";"StarredDimsElement";"AtomicLb";"OptionalVariableInitializerList";"OptionalCm";"AtomicRb"])]));
   ("ArrayInitializer",Just_a_concat(["AtomicLb";"OptionalVariableInitializerList";"OptionalCm";"AtomicRb"]));
   ("ArrayType",Disjunction([Concat(["PrimitiveType";"StarredAnnotation";"AtomicLb";"AtomicRb";"StarredDimsElement"]);Concat(["ClassOrInterfaceType";"StarredAnnotation";"AtomicLb";"AtomicRb";"StarredDimsElement"]);Concat(["StarredAnnotation";"Identifier";"StarredAnnotation";"AtomicLb";"AtomicRb";"StarredDimsElement"])]));
   ...
   ("CastExpression",Disjunction([Concat(["AtomicLp";"PrimitiveType";"AtomicRp";"UnaryExpression"]);Concat(["AtomicLp";"ReferenceType";"StarredAdditionalBound";"AtomicRp";"UnaryExpressionNotPlusMinus"]);Concat(["AtomicLp";"ReferenceType";"StarredAdditionalBound";"AtomicRp";"LambdaParameters";"AtomicMinus";"AtomicGt";"LambdaBody"])]));
   ("CatchClause",Just_a_concat(["AtomicCatch";"AtomicLp";"StarredVariableModifier";"UnannClassType";"StarredClassTypePrecededByVerticalBar";"Identifier";"OptionalDims";"AtomicRp";"AtomicLb";"OptionalBlockStatements";"AtomicRb"]));
   ("Catches",Just_a_concat(["AtomicCatch";"AtomicLp";"StarredVariableModifier";"UnannClassType";"StarredClassTypePrecededByVerticalBar";"Identifier";"OptionalDims";"AtomicRp";"AtomicLb";"OptionalBlockStatements";"AtomicRb";"StarredCatchClause"]));
   ...
   ("ClassInstanceCreationExpression",Disjunction([Concat(["AtomicNew";"OptionalTypeArguments";"StarredAnnotation";"Identifier";"StarredAnnotatedIdentifierrPrecededByDot";"OptionalTypeArgumentsOrDiamond";"AtomicLp";"OptionalArgumentList";"AtomicRp";"OptionalClassBody"]);Concat(["ExpressionName";"AtomicDot";"AtomicNew";"OptionalTypeArguments";"StarredAnnotation";"Identifier";"StarredAnnotatedIdentifierrPrecededByDot";"OptionalTypeArgumentsOrDiamond";"AtomicLp";"OptionalArgumentList";"AtomicRp";"OptionalClassBody"]);Concat(["Primary";"AtomicDot";"AtomicNew";"OptionalTypeArguments";"StarredAnnotation";"Identifier";"StarredAnnotatedIdentifierrPrecededByDot";"OptionalTypeArgumentsOrDiamond";"AtomicLp";"OptionalArgumentList";"AtomicRp";"OptionalClassBody"])]));
   ...
   ("ConditionalExpression",Disjunction([Concat(["ConditionalOrExpression"]);Concat(["ConditionalOrExpression";"AtomicCond";"Expression";"AtomicColon";"ConditionalExpression"]);Concat(["ConditionalOrExpression";"AtomicCond";"Expression";"AtomicColon";"LambdaParameters";"AtomicMinus";"AtomicGt";"LambdaBody"])]));
   ...
   ("Dims",Just_a_concat(["StarredAnnotation";"AtomicLb";"AtomicRb";"StarredDimsElement"]));
   ...
   ("ElementValuePairList",Just_a_concat(["Identifier";"AtomicEq";"ElementValue";"StarredElementValuePairPrecededByComma"]));
   ("ElementValuePairPrecededByComma",Just_a_concat(["AtomicCm";"Identifier";"AtomicEq";"ElementValue"]));
   ("ElementValuePrecededByComma",Just_a_concat(["AtomicCm";"ElementValue"]));
   ("EmptyStatement",Synonym("AtomicSm"));
   ("EnhancedForStatement",Just_a_concat(["AtomicFor";"AtomicLp";"StarredVariableModifier";"LocalVariableType";"Identifier";"OptionalDims";"OptionalEqualsVariableInitializer";"StarredVariableDeclaratorPrecededByComma";"AtomicColon";"Expression";"AtomicRp";"Statement"]));
   ("EnhancedForStatementNoShortIf",Just_a_concat(["AtomicFor";"AtomicLp";"StarredVariableModifier";"LocalVariableType";"Identifier";"OptionalDims";"OptionalEqualsVariableInitializer";"StarredVariableDeclaratorPrecededByComma";"AtomicColon";"Expression";"AtomicRp";"StatementNoShortIf"]));
   ...
   ("EnumDeclaration",Just_a_concat(["StarredClassModifier";"AtomicEnum";"Identifier";"OptionalClassImplements";"AtomicLb";"OptionalEnumConstantList";"OptionalCm";"OptionalEnumBodyDeclarations";"AtomicRb"]));
   ...
   ("ExplicitConstructorInvocation",Disjunction([Concat(["OptionalTypeArguments";"AtomicThis";"AtomicLp";"OptionalArgumentList";"AtomicRp";"AtomicSm"]);Concat(["OptionalTypeArguments";"AtomicSuper";"AtomicLp";"OptionalArgumentList";"AtomicRp";"AtomicSm"]);Concat(["ExpressionName";"AtomicDot";"OptionalTypeArguments";"AtomicSuper";"AtomicLp";"OptionalArgumentList";"AtomicRp";"AtomicSm"]);Concat(["Primary";"AtomicDot";"OptionalTypeArguments";"AtomicSuper";"AtomicLp";"OptionalArgumentList";"AtomicRp";"AtomicSm"])]));
   ("Expression",Just_a_disjunction(["LambdaExpression";"AssignmentExpression"]));
   ("ExpressionName",Disjunction([Concat(["Identifier"]);Concat(["AmbiguousName";"AtomicDot";"Identifier"])]));
   ...
   ("FieldAccess",Disjunction([Concat(["Primary";"AtomicDot";"Identifier"]);Concat(["AtomicSuper";"AtomicDot";"Identifier"]);Concat(["TypeName";"AtomicDot";"AtomicSuper";"AtomicDot";"Identifier"])]));
   ...
   ("Finally",Just_a_concat(["AtomicFinally";"AtomicLb";"OptionalBlockStatements";"AtomicRb"]));
   ...
   ("FormalParameter",Disjunction([Concat(["StarredVariableModifier";"UnannType";"Identifier";"OptionalDims"]);Concat(["StarredVariableModifier";"UnannType";"StarredAnnotation";"AtomicDot";"AtomicDot";"AtomicDot";"Identifier"])]));
   ...
   ("LambdaParameter",Disjunction([Concat(["StarredVariableModifier";"LambdaParameterType";"Identifier";"OptionalDims"]);Concat(["StarredVariableModifier";"UnannType";"StarredAnnotation";"AtomicDot";"AtomicDot";"AtomicDot";"Identifier"])]));
   ...
   ("MethodHeader",Disjunction([Concat(["Result";"Identifier";"AtomicLp";"OptionalReceiverParameterFollowedByComma";"OptionalFormalParameterList";"AtomicRp";"OptionalDims";"OptionalThrows"]);Concat(["AtomicLt";"StarredTypeParameterModifier";"Identifier";"OptionalTypeBound";"StarredTypeParameterPrecededByComma";"AtomicGt";"StarredAnnotation";"Result";"Identifier";"AtomicLp";"OptionalReceiverParameterFollowedByComma";"OptionalFormalParameterList";"AtomicRp";"OptionalDims";"OptionalThrows"])]));
   ("MethodInvocation",Disjunction([Concat(["MethodName";"AtomicLp";"OptionalArgumentList";"AtomicRp"]);Concat(["TypeName";"AtomicDot";"OptionalTypeArguments";"Identifier";"AtomicLp";"OptionalArgumentList";"AtomicRp"]);Concat(["ExpressionName";"AtomicDot";"OptionalTypeArguments";"Identifier";"AtomicLp";"OptionalArgumentList";"AtomicRp"]);Concat(["Primary";"AtomicDot";"OptionalTypeArguments";"Identifier";"AtomicLp";"OptionalArgumentList";"AtomicRp"]);Concat(["AtomicSuper";"AtomicDot";"OptionalTypeArguments";"Identifier";"AtomicLp";"OptionalArgumentList";"AtomicRp"]);Concat(["TypeName";"AtomicDot";"AtomicSuper";"AtomicDot";"OptionalTypeArguments";"Identifier";"AtomicLp";"OptionalArgumentList";"AtomicRp"])]));
   ...
   ("ModularCompilationUnit",Just_a_concat(["StarredImportDeclaration";"StarredAnnotation";"OptionalOpen";"AtomicModule";"Identifier";"StarredIdentifierPrecededByDot";"AtomicLb";"StarredModuleDirective";"AtomicRb"]));
   ...
   ("ModuleName",Disjunction([Concat(["Identifier"]);Concat(["ModuleName";"AtomicDot";"Identifier"])]));
   ...
   ("NormalClassDeclaration",Just_a_concat(["StarredClassModifier";"AtomicClass";"Identifier";"OptionalTypeParameters";"OptionalClassExtends";"OptionalClassImplements";"OptionalClassPermits";"AtomicLb";"StarredClassBodyDeclaration";"AtomicRb"]));
   ("NormalInterfaceDeclaration",Just_a_concat(["StarredInterfaceModifier";"AtomicInterface";"Identifier";"OptionalTypeParameters";"OptionalInterfaceExtends";"OptionalInterfacePermits";"AtomicLb";"StarredInterfaceMemberDeclaration";"AtomicRb"]));
   ...
   ("PackageName",Disjunction([Concat(["Identifier"]);Concat(["PackageName";"AtomicDot";"Identifier"])]));
   ("PackageOrTypeName",Disjunction([Concat(["Identifier"]);Concat(["PackageOrTypeName";"AtomicDot";"Identifier"])]));
   ...
   ("ReceiverParameterFollowedByComma",Just_a_concat(["StarredAnnotation";"UnannType";"OptionalIdentifierFollowedByDot";"AtomicThis";"AtomicCm"]));
   ...
   ("RecordComponent",Disjunction([Concat(["StarredRecordComponentModifier";"UnannType";"Identifier"]);Concat(["StarredRecordComponentModifier";"UnannType";"StarredAnnotation";"AtomicDot";"AtomicDot";"AtomicDot";"Identifier"])]));
   ...
   ("RecordDeclaration",Just_a_concat(["StarredClassModifier";"AtomicRecord";"Identifier";"OptionalTypeParameters";"AtomicLp";"OptionalRecordComponentList";"AtomicRp";"OptionalClassImplements";"AtomicLb";"StarredRecordBodyDeclaration";"AtomicRb"]));
   ...
   ("SingleStaticImportDeclaration",Just_a_concat(["AtomicImport";"AtomicStatic";"TypeName";"AtomicDot";"Identifier";"AtomicSm"]));
   ...
   ("StaticInitializer",Just_a_concat(["AtomicStatic";"AtomicLb";"OptionalBlockStatements";"AtomicRb"]));
   ...
   ("SwitchRule",Disjunction([Concat(["SwitchLabel";"AtomicMinus";"AtomicGt";"Expression";"AtomicSm"]);Concat(["SwitchLabel";"AtomicMinus";"AtomicGt";"AtomicLb";"OptionalBlockStatements";"AtomicRb"]);Concat(["SwitchLabel";"AtomicMinus";"AtomicGt";"AtomicThrow";"Expression";"AtomicSm"])]));
   ("SwitchStatement",Just_a_concat(["AtomicSwitch";"AtomicLp";"Expression";"AtomicRp";"SwitchBlock"]));
   ("SynchronizedStatement",Just_a_concat(["AtomicSynchronized";"AtomicLp";"Expression";"AtomicRp";"AtomicLb";"OptionalBlockStatements";"AtomicRb"]));
   ...
   ("TryStatement",Disjunction([Concat(["AtomicTry";"AtomicLb";"OptionalBlockStatements";"AtomicRb";"AtomicCatch";"AtomicLp";"StarredVariableModifier";"UnannClassType";"StarredClassTypePrecededByVerticalBar";"Identifier";"OptionalDims";"AtomicRp";"AtomicLb";"OptionalBlockStatements";"AtomicRb";"StarredCatchClause"]);Concat(["AtomicTry";"AtomicLb";"OptionalBlockStatements";"AtomicRb";"OptionalCatches";"AtomicFinally";"AtomicLb";"OptionalBlockStatements";"AtomicRb"]);Concat(["AtomicTry";"AtomicLp";"Resource";"StarredResourcePrecededBySemiColon";"OptionalSm";"AtomicRp";"AtomicLb";"OptionalBlockStatements";"AtomicRb";"OptionalCatches";"OptionalFinally"])]));
   ("TryWithResourcesStatement",Just_a_concat(["AtomicTry";"AtomicLp";"Resource";"StarredResourcePrecededBySemiColon";"OptionalSm";"AtomicRp";"AtomicLb";"OptionalBlockStatements";"AtomicRb";"OptionalCatches";"OptionalFinally"]));
   ...
   ("TypeArgumentsOrDiamond",Disjunction([Concat(["AtomicLt";"TypeArgument";"StarredTypeArgumentPrecededByComma";"AtomicGt"]);Concat(["AtomicLt";"AtomicGt"])]));
   ...
   ("UnannArrayType",Disjunction([Concat(["UnannPrimitiveType";"StarredAnnotation";"AtomicLb";"AtomicRb";"StarredDimsElement"]);Concat(["UnannClassOrInterfaceType";"StarredAnnotation";"AtomicLb";"AtomicRb";"StarredDimsElement"]);Concat(["UnannTypeVariable";"StarredAnnotation";"AtomicLb";"AtomicRb";"StarredDimsElement"])]));
   ...
   ("UnaryExpressionNotPlusMinus",Disjunction([Concat(["PostfixExpression"]);Concat(["AtomicCompl";"UnaryExpression"]);Concat(["AtomicNot";"UnaryExpression"]);Concat(["CastExpression"]);Concat(["AtomicSwitch";"AtomicLp";"Expression";"AtomicRp";"SwitchBlock"])]));
   ...
   ("VariableDeclaratorPrecededByComma",Just_a_concat(["AtomicCm";"Identifier";"OptionalDims";"OptionalEqualsVariableInitializer"]));
