...
#use "lib/Ocaml_preprocessing/Polymorphic_ocaml_records/prepare_gw_poly.ml";;
...
let methods = [
   ...
   "plunge_gw_configuration",false,["config"],None;
...
mod_details "plunge_gw_configuration" ([" let answer = [] in "],"") ;;
...
order "plunge_gw_configuration" ([" let answer = [] in "],"") ;;
...
needed_dirs "plunge_gw_configuration" ([" let answer = [] in "],"") ;;
...
needed_libs "plunge_gw_configuration" ([" let answer = [] in "],"") ;;
...
all_subdirectories "plunge_gw_configuration" ([" let answer = [] in "],"") ;;
...
all_printables "plunge_gw_configuration" ([" let answer = [] in "],"") ;;
...
let write_all () =
   write_all_to_file 
   (Absolute_path.of_string "lib/Filewatching/gw_with_dependencies.ml") ;;
