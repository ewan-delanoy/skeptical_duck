...
(* 
   ...
   Abstract_superficial_result_mode.global_check_by_d
...
(* 
   ...
   Abstract_solution_list_mode.global_check_by_d
...
(* 
   ...
   Abstract_qpl_length_mode.global_check_by_d
...
(* Beginning of item at  (2,[],IMD(0),Superficial_result,Upper_half) *)

let f_2_empty_superficial_result_upper_half (B b) (S n) = 
  if b=0 
  then (
        if (n mod 3)=0 
...
(* 
   ...
   Abstract_superficial_result_mode.global_check_by_d
    (2,[],IMD(0),Upper_half) f_2_empty_superficial_result_upper_half ;; 

*)

Hashtbl.add
 Warehouse.wet_hashtbl_for_superficial_result_upper_half
   (2,[]) f_2_empty_superficial_result_upper_half ;;

Warehouse.record_one_more_insertion (2,[],IMD(0),Superficial_result,Upper_half) ;;

(* End of item at  (2,[],IMD(0),Superficial_result,Upper_half) *)
...
(* Beginning of item at  (2,[],IMD(1),Qpe_core,Upper_half) *)

let f_2_empty_i1_qpe_core_upper_half (B _b) (S n) = 
   if n<=5 then Empty_point else
    P(1,[],B(n-5),S(n-3))
  ;;
...
(* 
   ...
   Abstract_qpe_core_mode.global_check_by_d
    (2,[],IMD(1),Upper_half) f_2_empty_i1_qpe_core_upper_half ;; 

*)

Hashtbl.add
 Warehouse.wet_hashtbl_for_qpe_core_upper_half
   (2,[],IMD(1)) f_2_empty_i1_qpe_core_upper_half ;;

Warehouse.record_one_more_insertion (2,[],IMD(1),Qpe_core,Upper_half) ;;

(* End of item at  (2,[],IMD(1),Qpe_core,Upper_half) *)
...
(* Beginning of item at  (2,[],IMD(1),Qpe_constraints,Upper_half) *)

let f_2_empty_i1_qpe_constraints_upper_half (B b) (S n) =  
...
(* 
   ...
   Abstract_qpe_constraints_mode.global_check_by_d
    (2,[],IMD(1),Upper_half) f_2_empty_i1_qpe_constraints_upper_half ;; 

*)

Hashtbl.add
 Warehouse.wet_hashtbl_for_qpe_constraints_upper_half
   (2,[],IMD(1)) f_2_empty_i1_qpe_constraints_upper_half ;;

Warehouse.record_one_more_insertion (2,[],IMD(1),Qpe_constraints,Upper_half) ;;

(* End of item at  (2,[],IMD(1),Qpe_constraints,Upper_half) *)
...
(* Beginning of item at  (2,[],IMD(1),Qpe_extension,Upper_half) *)

let f_2_empty_i1_qpe_extension_upper_half (B _b) (S n) = 
  if n=4 then [1;3;4] else 
  if n=5 then [1;2;4;5] else 
  [n-1;n]  ;;
...
(* 
   ...
   Abstract_qpe_extension_mode.global_check_by_d
    (2,[],IMD(1),Upper_half) f_2_empty_i1_qpe_extension_upper_half ;; 

*)

Hashtbl.add
 Warehouse.wet_hashtbl_for_qpe_extension_upper_half
   (2,[],IMD(1)) f_2_empty_i1_qpe_extension_upper_half ;;

Warehouse.record_one_more_insertion (2,[],IMD(1),Qpe_extension,Upper_half) ;;

(* End of item at  (2,[],IMD(1),Qpe_extension,Upper_half) *)
...
(* Beginning of item at  (2,[],IMD(2),Qpe_constraints,Upper_half) *)

let f_2_empty_i2_qpe_constraints_upper_half (B b) (S n) =  
  if n=b+4 
  then (
        if b=0 then [] else
...
(* 
   ...
   Abstract_qpe_constraints_mode.global_check_by_d
    (2,[],IMD(2),Upper_half) f_2_empty_i2_qpe_constraints_upper_half ;; 

*)

Hashtbl.add
 Warehouse.wet_hashtbl_for_qpe_constraints_upper_half
   (2,[],IMD(2)) f_2_empty_i2_qpe_constraints_upper_half ;;

Warehouse.record_one_more_insertion (2,[],IMD(2),Qpe_constraints,Upper_half) ;;

(* End of item at  (2,[],IMD(2),Qpe_constraints,Upper_half) *)
...
(* End of item at  (2,[],IMD(3),Qpe_extension,Lower_half) *)
(* Beginning of item at  (2,[],IMD(3),Qpe_extension,Upper_half) *)

let f_2_empty_i3_qpe_extension_upper_half (B _b) (S n) = 
  if n=3 then [1;2] else 
    [] 
  ;;
...
(* 
   ...
   Abstract_qpe_extension_mode.global_check_by_d
    (2,[],IMD(3),Upper_half) f_2_empty_i3_qpe_extension_upper_half ;; 

*)

Hashtbl.add
 Warehouse.wet_hashtbl_for_qpe_extension_upper_half
   (2,[],IMD(3)) f_2_empty_i3_qpe_extension_upper_half ;;

Warehouse.record_one_more_insertion (2,[],IMD(3),Qpe_extension,Upper_half) ;;

(* End of item at  (2,[],IMD(3),Qpe_extension,Upper_half) *)(* End of warehouse fillings. Do not modify this line *)
end ;;   
