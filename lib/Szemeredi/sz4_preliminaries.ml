...
type extension_data = Sz4_types.extension_data  ;; 

type solution = Sz4_types.solution ;; 

type point = Sz4_types.point = P of finite_int_set * width ;; 

type quantify_constraints = Sz4_types.quantify_constraints =
    Some_constraints
    |All_constraints ;; 


type point_with_breadth = Sz4_types.point_with_breadth = 
     No_constraint of finite_int_set
    |Usual of quantify_constraints * point * int ;; 

type handle = Sz4_types.handle = 
   Has_no_constraints
...
type small_mold = Sz4_types.small_mold = SM of (solution list) * fan ;; 

type mold = Sz4_types.mold = BM of extension_data * (int * small_mold) list ;;

type common_table = Sz4_types.common_table = CT of  (point_with_breadth * (handle * mold)) list ;; 
  
type diagnosis = Sz4_types.diagnosis =
...
type point_with_requirements = Sz4_types.point_with_requirements = PWR of point_with_breadth * ( (int * fan) list ) ;;
