...
let self_contained_module_copy prefix hm=
   ...
   let those_above=( Fwc_final_poly.Lfw_with_dependencies.ancestors_for_module fw nm)@[nm] in
   let temp1=Image.image (
       fun nm2->
         let hm2=Fwc_final_poly.Lfw_with_dependencies.endingless_at_module fw nm2 in
