...
[]->graet
|a::peurrest->tempf(peurrest,graet@(Image.imagination(function y->a::y)(graet)))
) in
tempf(List.rev(l),[[]]);;
...
let partition_from_set_of_ranges l n=
    ...
    let temp3=Image.imagination (fun ((i1,j1),(i2,j2))->
...
let extract_intervals_in_complement l n =
   ...
   let temp2= Image.imagination (fun (x,y)->(x+1,y-1)) temp1 in 
...
let split_list_in_half l=
   ...
   (Image.imagination snd temp2,Image.imagination snd temp3);;
