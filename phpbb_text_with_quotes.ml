...
let first_analysis text= Image.imagination (fun (opt,content)->
  (opt=None,content)
...
let first_analysis text= Image.imagination (rewrite_first_result text)
(Functional_parenthesed_block.decompose_without_taking_blanks_into_account 
[("php","bb"),detect_phpbb_quote_start_at_index,detect_phpbb_quote_end_at_index] text);;   
...
let rec unparse = function 
   ...
   |Concatenated l -> String.concat "" (Image.imagination unparse l)
...
let g2 = Image.imagination rewrite_element g1 ;;
