...
let list_of_triples l=
 ...
 (j1,x1,da_ober1,accu)->
  ...
  then List.rev(accu)
       ...
       let temp2=Image.imagination(function (x2,x3)->(x1,x2,x3))(temp1) in
...
let list_of_fourtuples l=
 ...
 (j1,x1,da_ober1,accu)->
  ...
  then List.rev(accu)
       ...
       let temp2=Image.imagination(function (x2,x3,x4)->(x1,x2,x3,x4))(temp1) in
       tempf(j1-1,List.hd(da_ober1),List.tl(da_ober1), List.rev_append(temp2)(accu))
  ) in
  tempf(List.length(l)-1,List.hd(l),List.tl(l),[]);;
...
let list_of_fiftuples l=
 ...
 (j1,x1,da_ober1,accu)->
  ...
  then List.rev(accu)
       ...
       let temp2=Image.imagination(function (x2,x3,x4,x5)->(x1,x2,x3,x4,x5))(temp1) in
       tempf(j1-1,List.hd(da_ober1),List.tl(da_ober1), List.rev_append(temp2)(accu))
  ) in
  tempf(List.length(l)-1,List.hd(l),List.tl(l),[]);;
...
let list_of_sixtuples l=
 ...
 (j1,x1,da_ober1,accu)->
  ...
  then List.rev(accu)
       ...
       let temp2=Image.imagination(function (x2,x3,x4,x5,x6)->(x1,x2,x3,x4,x5,x6))(temp1) in
       tempf(j1-1,List.hd(da_ober1),List.tl(da_ober1), List.rev_append(temp2)(accu))
  ) in
  tempf(List.length(l)-1,List.hd(l),List.tl(l),[]);;
...
sub_f([],l);;
 ...
 let rec partial_power_set k l=
  if k=0 then [[]] else
  if k=1 then Image.imagination(function x->[x])(l) else
 ...
 (j,x,da_ober,graet)->
  ...
  then List.rev(graet)
       ...
       let temp2=Image.imagination(function y->x::y)(temp1) in
 ...
 let cumulative_partial_power_set l k=
  ...
  let rec l_naive_combinations k l=
   ...
   let first_part_of_answer=Image.imagination(function x->a::x)(l_naive_combinations (k-1) peurrest)
  ...
  let naive_combinations k l=
   Image.imagination Set_of_polys.safe_set (l_naive_combinations k (Set_of_polys.forget_order l));;
  ...
  let combinations k l=
   ...
   let arrangements_in_above_board_case the_k l=
    ...
    let temp4=Image.imagination (function (x,y)->x::y)(temp3) in
    temp4) in
    tempf the_k;;
